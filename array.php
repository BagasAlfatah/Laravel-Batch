    ...
    /*
        ...
        */
        ...
        $child = array(
            ...
            ["Name" => "Will Byers",  "Age" => 12, "Aliases" => "Will the Wise", "Status" => "Alive"], "<br>",

            ["Name" => "Mike Wheeler",  "Age" => 12, "Aliases" => "Dungeon Master", "Status" => "Alive"], "<br>",

            ["Name" => "Jim Hopper",  "Age" => 43, "Aliases" => "Chief Hopper", "Status" => "Alive"], "<br>",
